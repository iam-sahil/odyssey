...
export const index: Record<string, any> = {
    ...
    files: [
      {
        ...
        content:
          "'use client';\n\nimport * as React from 'react';\n\nimport { PlayfulTodolist } from '@/components/odyssey/components/community/playful-todolist';\n\nexport const PlayfulTodolistDemo = () => <PlayfulTodolist />;",
      },
    ],
    keywords: [],
    component: (function () {
  ...
  'demo-primitives-base-menu': {
    ...
    dependencies: undefined,
    devDependencies: undefined,
    registryDependencies: ['@animate-ui/primitives-base-menu'],
    files: [
      {
  ...
  'demo-primitives-base-radio': {
    ...
    dependencies: undefined,
    devDependencies: undefined,
    registryDependencies: ['@animate-ui/primitives-base-radio'],
    files: [
      {
    ...
    component: (function () {
      ...
      LazyComp.demoProps = {
        TabsPanels: {
          mode: {
            value: 'auto-height',
            options: { 'auto-height': 'auto-height', layout: 'layout' },
          },
        },
      };
      return LazyComp;
  ...
  'demo-primitives-effects-click': {
    ...
    dependencies: undefined,
    devDependencies: undefined,
    registryDependencies: ['@animate-ui/primitives-effects-click'],
    files: [
      {
    ...
    component: (function () {
      ...
      LazyComp.demoProps = {
        Click: {
          ...
          duration: { value: 400, min: 0, max: 3000, step: 100 },
          size: { value: 100, min: 0, max: 300, step: 10 },
        },
      };
      return LazyComp;
    })(),
    ...
    files: [
      {
        ...
        content:
          'import { Effect } from \'@/components/odyssey/primitives/effects/effect\';\n\ntype EffectDemoProps = {\n  delay?: number;\n  blur?: boolean;\n  slide?: boolean;\n  fade?: boolean;\n  zoom?: boolean;\n};\n\nexport default function EffectDemo({\n  delay = 0,\n  blur = false,\n  slide = false,\n  fade = false,\n  zoom = false,\n}: EffectDemoProps) {\n  return (\n    <Effect\n      delay={delay}\n      blur={blur}\n      slide={slide}\n      fade={fade}\n      zoom={zoom}\n      className="px-6 py-4 bg-accent"\n    >\n      Effect\n    </Effect>\n  );\n}',
      },
    ],
    keywords: [],
    component: (function () {
    ...
    files: [
      {
        ...
        content:
          'import { Fade } from \'@/components/odyssey/primitives/effects/fade\';\n\ntype FadeDemoProps = {\n  delay?: number;\n  initialOpacity?: number;\n  opacity?: number;\n};\n\nexport default function FadeDemo({\n  delay = 0,\n  initialOpacity = 0,\n  opacity = 1,\n}: FadeDemoProps) {\n  return (\n    <Fade\n      delay={delay}\n      initialOpacity={initialOpacity}\n      opacity={opacity}\n      className="px-6 py-4 bg-accent"\n    >\n      Fade\n    </Fade>\n  );\n}',
      },
    ],
    keywords: [],
    component: (function () {
  ...
  'demo-primitives-effects-image-zoom': {
    ...
    dependencies: undefined,
    devDependencies: undefined,
    registryDependencies: ['@animate-ui/primitives-effects-image-zoom'],
    files: [
      {
  ...
  'demo-primitives-effects-shine': {
    ...
    dependencies: undefined,
    devDependencies: undefined,
    registryDependencies: ['@animate-ui/primitives-effects-shine'],
    files: [
      {
    ...
    component: (function () {
      ...
      LazyComp.demoProps = {
        Slide: {
          delay: { value: 0, min: 0, max: 3000, step: 100 },
          duration: { value: 1200, min: 0, max: 3000, step: 100 },
          loop: { value: true },
          loopDelay: { value: 500, min: 0, max: 3000, step: 100 },
          deg: { value: -15, min: -50, max: 50, step: 5 },
          enable: { value: true },
          enableOnHover: { value: false },
          enableOnTap: { value: false },
        },
      };
      return LazyComp;
    })(),
    ...
    files: [
      {
        ...
        content:
          "import {\n  Slide,\n  type SlideDirection,\n} from '@/components/odyssey/primitives/effects/slide';\n\ntype SlideDemoProps = {\n  delay?: number;\n  direction?: SlideDirection;\n  offset?: number;\n};\n\nexport default function SlideDemo({\n  delay = 0,\n  direction = 'up',\n  offset = 100,\n}: SlideDemoProps) {\n  return (\n    <Slide\n      delay={delay}\n      direction={direction}\n      offset={offset}\n      className=\"px-6 py-4 bg-accent\"\n    >\n      Slide\n    </Slide>\n  );\n}",
      },
    ],
    keywords: [],
    component: (function () {
    ...
    files: [
      {
        ...
        content:
          'import { Zoom } from \'@/components/odyssey/primitives/effects/zoom\';\n\ntype ZoomDemoProps = {\n  delay?: number;\n  initialScale?: number;\n  scale?: number;\n};\n\nexport default function ZoomDemo({\n  delay = 0,\n  initialScale = 0.5,\n  scale = 1,\n}: ZoomDemoProps) {\n  return (\n    <Zoom\n      delay={delay}\n      initialScale={initialScale}\n      scale={scale}\n      className="px-6 py-4 bg-accent"\n    >\n      Zoom\n    </Zoom>\n  );\n}',
      },
    ],
    keywords: [],
    component: (function () {
    ...
    files: [
      {
        ...
        content:
          "import { Switch, SwitchThumb } from '@/components/odyssey/primitives/headless/switch';\nimport { Field, Label } from '@headlessui/react';\nimport { cn } from '@/lib/utils';\n\nexport const HeadlessSwitchDemo = () => {\n  return (\n    <Field>\n      <Label className=\"flex items-center gap-x-3\">\n        <Switch\n          className={cn(\n            'relative flex p-0.5 h-6 w-10 items-center justify-start rounded-full border transition-colors',\n            'data-[checked]:bg-primary data-[checked]:justify-end',\n          )}\n          defaultChecked\n        >\n          <SwitchThumb\n            className=\"rounded-full bg-accent h-full aspect-square\"\n            pressedAnimation={{ width: 22 }}\n          />\n        </Switch>\n        Airplane mode\n      </Label>\n    </Field>\n  );\n};",
      },
    ],
    keywords: [],
    component: (function () {
    ...
    files: [
      {
        ...
        content:
          'import {\n  Dialog,\n  DialogTrigger,\n  DialogContent,\n  DialogHeader,\n  DialogTitle,\n  DialogDescription,\n  DialogFooter,\n  DialogPortal,\n  DialogOverlay,\n  DialogClose,\n  type DialogFlipDirection,\n} from \'@/components/odyssey/primitives/radix/dialog\';\nimport { X } from \'lucide-react\';\n\ntype RadixDialogDemoProps = {\n  from: DialogFlipDirection;\n};\n\nexport const RadixDialogDemo = ({ from }: RadixDialogDemoProps) => {\n  return (\n    <Dialog>\n      <DialogTrigger className="bg-primary text-primary-foreground px-4 py-2 text-sm">\n        Open Dialog\n      </DialogTrigger>\n\n      <DialogPortal>\n        <DialogOverlay className="fixed inset-0 z-50 bg-black/80" />\n        <DialogContent\n          from={from}\n          className="sm:max-w-md fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] z-50 border bg-background p-6"\n        >\n          <DialogHeader>\n            <DialogTitle className="text-lg">Terms of Service</DialogTitle>\n            <DialogDescription className="text-sm">\n              Please read the following terms of service carefully.\n            </DialogDescription>\n          </DialogHeader>\n\n          <p className="py-4 text-sm text-muted-foreground">\n            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam,\n            quos. Lorem ipsum dolor sit amet consectetur adipisicing elit.\n            Quisquam, quos.\n          </p>\n\n          <DialogFooter>\n            <button className="bg-primary text-primary-foreground px-4 py-2 text-sm">\n              Accept\n            </button>\n          </DialogFooter>\n\n          <DialogClose className="absolute top-4 right-4">\n            <X className="size-4" />\n            <span className="sr-only">Close</span>\n          </DialogClose>\n        </DialogContent>\n      </DialogPortal>\n    </Dialog>\n  );\n};',
      },
    ],
    keywords: [],
    component: (function () {
    ...
    files: [
      {
        ...
        content:
          'import {\n  File,\n  FileHighlight,\n  FileIcon,\n  FileLabel,\n  Files,\n  FilesHighlight,\n  Folder,\n  FolderContent,\n  FolderHeader,\n  FolderHighlight,\n  FolderIcon,\n  FolderItem,\n  FolderTrigger,\n} from \'@/components/odyssey/primitives/radix/files\';\nimport {\n  FolderOpenIcon,\n  FolderIcon as LucideFolderIcon,\n  FileIcon as LucideFileIcon,\n} from \'lucide-react\';\n\nexport const FilesDemo = () => {\n  return (\n    <div className="relative size-full border bg-background overflow-auto">\n      <Files className="p-3" defaultOpen={[\'folder-1\']}>\n        <FilesHighlight className="bg-accent pointer-events-none">\n          <FolderItem value="folder-1">\n            <FolderHeader>\n              <FolderTrigger className="w-full text-start">\n                <FolderHighlight>\n                  <Folder className="flex items-center gap-2 p-2 pointer-events-none">\n                    <FolderIcon\n                      closeIcon={<LucideFolderIcon className="size-4.5" />}\n                      openIcon={<FolderOpenIcon className="size-4.5" />}\n                    />\n                    <FileLabel className="text-sm">Folder 1</FileLabel>\n                  </Folder>\n                </FolderHighlight>\n              </FolderTrigger>\n            </FolderHeader>\n\n            <div className="relative ml-8 before:absolute before:-left-3 before:inset-y-0 before:w-px before:h-full before:bg-border">\n              <FolderContent>\n                <FileHighlight>\n                  <File className="flex items-center gap-2 p-2 pointer-events-none">\n                    <FileIcon>\n                      <LucideFileIcon className="size-4.5" />\n                    </FileIcon>\n                    <FileLabel className="text-sm">File 1</FileLabel>\n                  </File>\n                </FileHighlight>\n\n                <Files defaultOpen={[\'folder-2\']}>\n                  <FolderItem value="folder-2">\n                    <FolderHeader>\n                      <FolderTrigger className="w-full text-start">\n                        <FolderHighlight>\n                          <Folder className="flex items-center gap-2 p-2 pointer-events-none">\n                            <FolderIcon\n                              closeIcon={\n                                <LucideFolderIcon className="size-4.5" />\n                              }\n                              openIcon={<FolderOpenIcon className="size-4.5" />}\n                            />\n                            <FileLabel className="text-sm">Folder 2</FileLabel>\n                          </Folder>\n                        </FolderHighlight>\n                      </FolderTrigger>\n                    </FolderHeader>\n\n                    <div className="relative ml-8 before:absolute before:-left-3 before:inset-y-0 before:w-px before:h-full before:bg-border">\n                      <FolderContent>\n                        <FileHighlight>\n                          <File className="flex items-center gap-2 p-2 pointer-events-none">\n                            <FileIcon>\n                              <LucideFileIcon className="size-4.5" />\n                            </FileIcon>\n                            <FileLabel className="text-sm">File 2</FileLabel>\n                          </File>\n                        </FileHighlight>\n                        <FileHighlight>\n                          <File className="flex items-center gap-2 p-2 pointer-events-none">\n                            <FileIcon>\n                              <LucideFileIcon className="size-4.5" />\n                            </FileIcon>\n                            <FileLabel className="text-sm">File 3</FileLabel>\n                          </File>\n                        </FileHighlight>\n                      </FolderContent>\n                    </div>\n                  </FolderItem>\n\n                  <FileHighlight>\n                    <File className="flex items-center gap-2 p-2 pointer-events-none">\n                      <FileIcon>\n                        <LucideFileIcon className="size-4.5" />\n                      </FileIcon>\n                      <FileLabel className="text-sm">File 4</FileLabel>\n                    </File>\n                  </FileHighlight>\n                </Files>\n              </FolderContent>\n            </div>\n          </FolderItem>\n\n          <FileHighlight>\n            <File className="flex items-center gap-2 p-2 pointer-events-none">\n              <FileIcon>\n                <LucideFileIcon className="size-4.5" />\n              </FileIcon>\n              <FileLabel className="text-sm">File 5</FileLabel>\n            </File>\n          </FileHighlight>\n        </FilesHighlight>\n      </Files>\n    </div>\n  );\n};',
      },
    ],
    keywords: [],
    component: (function () {
    ...
    files: [
      {
        ...
        content:
          'import {\n  Toggle,\n  ToggleHighlight,\n  ToggleItem,\n} from \'@/components/odyssey/primitives/radix/toggle\';\nimport { Bold } from \'lucide-react\';\n\nexport const RadixToggleDemo = () => {\n  return (\n    <Toggle className="relative size-8 flex items-center justify-center">\n      <ToggleHighlight className="bg-accent" />\n      <ToggleItem>\n        <Bold className="h-4 w-4" />\n      </ToggleItem>\n    </Toggle>\n  );\n};',
      },
    ],
    keywords: [],
    component: (function () {
  ...
  'demo-primitives-texts-morphing': {
    ...
    dependencies: undefined,
    devDependencies: undefined,
    registryDependencies: ['@animate-ui/primitives-texts-morphing'],
    files: [
      {
    ...
    component: (function () {
      ...
      LazyComp.demoProps = {
        MorphingText: {
          loop: { value: true },
          holdDelay: { value: 2500, min: 0, max: 3000, step: 100 },
        },
      };
      return LazyComp;
    })(),
  ...
  'primitives-base-menu': {
    ...
    component: (function () {
      const LazyComp = React.lazy(async () => {
        const mod = await import('@/registry/primitives/base/menu/index.tsx');
        const exportName =
          Object.keys(mod).find(
            (key) =>
              typeof mod[key] === 'function' || typeof mod[key] === 'object',
  ...
  'primitives-base-radio': {
    ...
    component: (function () {
      const LazyComp = React.lazy(async () => {
        const mod = await import('@/registry/primitives/base/radio/index.tsx');
        const exportName =
          Object.keys(mod).find(
            (key) =>
              typeof mod[key] === 'function' || typeof mod[key] === 'object',
